...
# আপনার গুগল শিটের আইডি এখানে সফলভাবে বসানো হয়েছে
SHEET_ID = "1Qnoh_HhHLVZyJWt0ZLBSLiNToUG8sPLxB46G7yNwsO0"
CSV_URL = f"https://docs.google.com/spreadsheets/d/{SHEET_ID}/gviz/tq?tqx=out:csv"

# গুগল শিট থেকে ডাটা রিড করা এবং জাভা-স্ক্রিপ্টের জন্য ফরম্যাট করা
try:
    df = pd.read_csv(CSV_URL)
    # কলামের নামগুলো ছোট হাতের অক্ষরে এবং স্পেস মুক্ত করা
    df.columns = df.columns.str.strip().str.lower()
    
    # প্রশ্ন-উত্তর জোড়া তৈরি করে ডিকশনারিতে রূপান্তর
    qa_dict = dict(zip(df['question'].astype(str).str.lower().str.strip(), df['answer'].astype(str).str.strip()))
    qa_json = json.dumps(qa_dict, ensure_ascii=False)
except Exception as e:
    st.error("গুগল শিট থেকে ডাটা লোড করা যাচ্ছে না! অনুগ্রহ করে লিঙ্কের পারমিশন চেক করুন।")
    qa_json = "{}"
